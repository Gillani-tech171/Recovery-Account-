          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="RecoveryData.php" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-aperture"></i>
                  </span>
                  <span class="hide-menu">Recovery Account</span>
                </div>
            ...
            <!-- <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="RecoveryData2.php" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-aperture"></i>
                  </span>
                  <span class="hide-menu">Shared Account</span>
                </div>
